...
bind("Return", app(terminal), "[common] Open terminal")
bind("Z", app(terminal .. " -e zellij"), "Open terminal workspace")
bind("B", app(browser), "[common] Open browser")
bind("E", app(file_manager), "[common] Open files")
bind("R", app(launcher), "Open application launcher")
bind("SPACE", app(launcher), "[common] Open application launcher")
...
bind_shift("v", app("clear-clipboard-history"), "Clear clipboard history")
...
bind("SHIFT + slash", app("hypr-keybinds --menu"), "[common] Show shortcut help")

bind("Q", hl.dsp.window.close(), "Close window")
bind_shift("f", toggle_float, "Toggle floating window")
bind_shift("g", hl.dsp.window.fullscreen({ action = "toggle" }), "Toggle fullscreen")
