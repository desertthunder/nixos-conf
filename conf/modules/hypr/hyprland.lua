...
bind("Return", app(terminal))
bind("Z", app(terminal .. " -e zellij"))
bind("B", app(browser))
bind("E", app(file_manager))
bind("R", app(launcher))
bind("SPACE", app(launcher))
bind("SHIFT + R", run("hyprctl reload"))
bind("P", app("rofi -show run"))
bind("V", app("clipboard-picker"))
bind_shift("v", app("clear-clipboard-history"))
bind("N", run("makoctl restore"))
bind_shift("n", run("makoctl mode -t do-not-disturb"))
bind_shift("l", run("loginctl lock-session"))
...
hl.bind("Print", app(screenshot .. " region"))
hl.bind("SHIFT + Print", app(screenshot .. " full"))
hl.bind("CTRL + Print", app(screenshot .. " region no-edit"))
hl.bind("CTRL + SHIFT + Print", app(screenshot .. " full no-edit"))

bind_repeat("XF86AudioRaiseVolume", "swayosd-client --output-volume raise --max-volume 100")
bind_repeat("XF86AudioLowerVolume", "swayosd-client --output-volume lower")
bind_repeat("XF86AudioMute", "swayosd-client --output-volume mute-toggle")
bind_repeat("XF86AudioMicMute", "swayosd-client --input-volume mute-toggle")
bind_repeat("XF86MonBrightnessUp", "swayosd-client --brightness raise")
bind_repeat("XF86MonBrightnessDown", "swayosd-client --brightness lower")
