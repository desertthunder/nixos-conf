...
description: "A comparison of the supported NixOS, macOS, Ubuntu, and Fedora setup paths."
section: "Platforms"
weight: 140
---
...
2. **Non-Nix systems** — macOS, Ubuntu, and Fedora managed by `dotfiler`, package-manager-native package lists, portable dotfiles, and SOPS + age.
...
Linux system settings live in `lib/nix/modules/nixos/`, with host-specific overrides in `lib/nix/hosts/`.
