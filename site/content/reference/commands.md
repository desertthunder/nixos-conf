...
description: "Copy-paste commands for rebuilding NixOS, maintaining flakes, handling SOPS, and troubleshooting hosts."
section: "Reference"
weight: 120
---
...
# Add new secret key
sops -s lib/secrets/owais.yaml

# Test decryption (requires proper key setup)
sops -d lib/secrets/owais.yaml
```
...
# lib/nix/hosts/{machine}/hardware-configuration.nix
```
