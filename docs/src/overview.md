...
For system administration commands, see the [NixOS Configuration](./nixos/overview.md) guide.

For multi-machine setup details, see the [Multi-Machine Setup](./nixos/multi-machine.md) guide.
